...
def training_loop(dataloader_X, dataloader_Y, test_dataloader_X, test_dataloader_Y, opts):
    ...
    for iteration in range(1, opts.train_iters+1):
        ...
        g_loss = ((D_X(fake_X) - 1)**2).sum()/len(fake_X)
...
def create_parser():
    ...
    # Data sources
    parser.add_argument('--X', type=str, default='Pointilism', choices=['Pointilism'], help='Choose the type of images for domain X.')
    parser.add_argument('--Y', type=str, default='Pointilism', choices=['Pointilism'], help='Choose the type of images for domain Y.')
